...
> **Статус: в работе** — седьмое исправление (`6340952`, версия 0.23.1) проверено
> на устройстве и НЕ устранило проблему, баг воспроизводится тем же способом.
>
...
**Коммит:** `<см. историю после 6340952>` («Версия 0.23.2», диагностическая).

Как проверить: включить «Записывать лог в файл» на вкладке «Резервные копии»,
повторить последовательность 1–8 из раздела выше, экспортировать/просмотреть
логи, найти записи с тегом `AccentDebug`.
