...
- Auto Backup через Android Backup Service
- Функции Export/Import базы данных для ручного резервного копирования
...
- Удалены текстовые подписи под всеми переключателями (только иконки)
